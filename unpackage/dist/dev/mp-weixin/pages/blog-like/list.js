...
const _sfc_main = {
  data() {
    return {
      collectionList: [
        db.collection("blog-like").field("_id,article_id,user_id").getTemp(),
        db.collection("blog-articles").field("_id,title").getTemp()
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
      ...
      return common_vendor.e({
        ...
        d: common_vendor.f(data, (item, index, i1) => {
          return {
            ...
            d: "3b743404-2-" + i0 + "-" + i1 + "," + ("3b743404-1-" + i0)
          };
        }),
        e: common_vendor.p({
          showArrow: true,
        ...
        f: "3b743404-1-" + i0 + ",3b743404-0"
      } : {}, {
        c: data,
        g: "3b743404-3-" + i0 + ",3b743404-0",
        h: common_vendor.p({
    ...
    b: common_vendor.sr("udb", "3b743404-0"),
    c: common_vendor.p({
