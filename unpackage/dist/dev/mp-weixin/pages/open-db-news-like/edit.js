...
const _sfc_main = {
  ...
  methods: {
    ...
    getDetail(id) {
      ...
      db.collection(dbCollectionName).doc(id).field("article_id,comments_id,like_type,status,user_id,create_date").get().then((res) => {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    t: common_vendor.sr("form", "0da6fa47-0"),
    v: common_vendor.p({
      model: $data.formData,
