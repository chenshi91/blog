...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
      ...
      return common_vendor.e({
        ...
        d: common_vendor.f(data, (item, index, i1) => {
          return {
            ...
            d: "385abe58-2-" + i0 + "-" + i1 + "," + ("385abe58-1-" + i0)
          };
        }),
        e: common_vendor.p({
          showArrow: true,
        ...
        f: "385abe58-1-" + i0 + ",385abe58-0"
      } : {}, {
        c: data,
        g: "385abe58-3-" + i0 + ",385abe58-0",
        h: common_vendor.p({
    ...
    b: common_vendor.sr("udb", "385abe58-0"),
    c: common_vendor.p({
      collection: "opendb-news-articles",
      field: "_id,title,article_status,user_id,publish_date",
      where: "user_id==$cloudEnv_uid&&article_status==1",
      orderby: "publish_date desc"
    }),
    d: common_vendor.sr("fab", "385abe58-4"),
