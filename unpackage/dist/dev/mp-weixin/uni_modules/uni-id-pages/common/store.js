...
const mutations = {
  ...
  async logout() {
    ...
    common_vendor.index.redirectTo({
      url: `/${common_vendor.pageJson.uniIdRouter && common_vendor.pageJson.uniIdRouter.loginPage ? common_vendor.pageJson.uniIdRouter.loginPage : "uni_modules/uni-id-pages/pages/login/login-withoutpwd"}`
    });
