...
const uni_modules_uviewPlus_components_uParse_parser = require("./parser.js");
...
const _sfc_main = {
  ...
  methods: {
    ...
    setContent(content, append) {
      ...
      const nodes = new uni_modules_uviewPlus_components_uParse_parser.Parser(this).parse(content);
