...
const _sfc_main = {
  name: "UniClouddb",
  setup(props) {
    const dataListRef = props.ssrKey ? props.getone ? common_vendor.shallowSsrRef(void 0, props.ssrKey) : common_vendor.ssrRef([], props.ssrKey) : props.getone ? common_vendor.shallowSsrRef(void 0, "UFrT4q9suZWHNPz1JyjdXg==") : common_vendor.ssrRef([], "nE0OjAuLkEcGbcNN3bBPkg==");
