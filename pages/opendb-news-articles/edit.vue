<template>
  <view class="uni-container">
    <uni-forms ref="form" :model="formData" validate-trigger="submit" err-show-type="toast">
      <uni-forms-item name="user_id" label="发布者" required>
      ...
      <uni-forms-item name="comment_status" label="开放评论">
        <switch @change="binddata('comment_status', $event.detail.value)" :checked="formData.comment_status"></switch>
      </uni-forms-item>
  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("user_id,category_id,title,content,excerpt,article_status,view_count,comment_status,last_comment_user_id,avatar,last_modify_date,last_modify_ip,mode,publish_date").get().then((res) => {
